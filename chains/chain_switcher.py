...
import pandas as pd
from tools.text_to_sql_runnable_snowflake import run_query as sql_runnable_snowflake
...
def run_chain(llm, chain, memory, prompt, df=None):
    ...
    if chain == "Ask Kendra":
        ...
        response, sources, intermediate_steps = sql_runnable_snowflake(llm, prompt)
